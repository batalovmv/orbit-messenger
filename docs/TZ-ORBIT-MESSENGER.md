...
- **GitHub:** `alex4udak-blip/orbit-messenger` (private)
- **Prod URL:** `https://orbit-messenger-7aombi.saturn.ac`
- **Backend API:** `https://orbit-messenger-4ngxa0.saturn.ac/api/v1`
...
- **Base URL:** `https://api.orbit.mst.com/api/v1` (будущий домен)

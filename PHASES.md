...
- [x] Grafana — local-dev real-time dashboards (SLO Overview + Service Health, auto-provisioned via `monitoring/grafana/`, port 3001). Saturn provisioning still TODO.
...
- [ ] Input validation (XSS, SQL injection) — spot-checked, need systematic pass

...
- [x] sendPhoto, sendDocument (multipart upload → media service → messaging). sendVoice — deferred
...
- [x] Docker healthchecks — infra OK, app /health exists
- [ ] OWASP Top 10 full sweep — spot-check passed
- [ ] Input validation — systematic pass
- [ ] Secrets rotation — manual при деплое
- [ ] Penetration test
- [ ] GPL-3.0 compliance: license headers

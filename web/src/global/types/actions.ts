...
export interface ActionPayloads {
  ...
  openAdminPanel: ({ tab?: 'users' | 'flags' | 'maintenance' | 'audit' | 'welcome' | 'push' } & WithTabId) | undefined;
  closeAdminPanel: WithTabId | undefined;
  selectAdminTab: { tab: 'users' | 'flags' | 'maintenance' | 'audit' | 'welcome' | 'push' } & WithTabId;

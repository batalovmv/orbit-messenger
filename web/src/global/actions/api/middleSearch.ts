...
async function searchSharedMedia<T extends GlobalState>(
  ...
  global = addUserStatuses(global, userStatusesById);
  global = addChatMessagesById(global, resultChatId, byId as Record<number, ApiMessage>);
  global = updateSharedMediaSearchResults(
...
async function searchChatMedia<T extends GlobalState>(
  ...
  const filteredIds = getMessageContentIds(byId as Record<number, ApiMessage>, newFoundIds, 'media');

...
import type { MethodArgs, Methods } from '../../api/saturn/methods/types';

// Saturn doesn't use GramJS LocalDb — stub for broadcast channel compat
type LocalDb = Record<string, Record<string, any>>;

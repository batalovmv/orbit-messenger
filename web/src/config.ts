...
export const WEB_VERSION_BASE = 'https://orbit.local/'; // Used to redirect to other versions
...
export const PAGE_TITLE_TAURI = 'Orbit';
...
export const TME_WEB_DOMAINS = new Set<string>();
...
export const IS_CALLS_ENABLED = true;

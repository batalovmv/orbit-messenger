...
const REACTION_ANIMATIONS: Record<string, ReactionAnimationAsset> = {
  '❤️': {
    center: HeartCenter, around: HeartAround, appear: HeartAppear,
    select: HeartSelect, effect: HeartEffect, activate: HeartActivate,
  },
  '👍': {
    center: ThumbsUpCenter, around: ThumbsUpAround, appear: ThumbsUpAppear,
    select: ThumbsUpSelect, effect: ThumbsUpEffect, activate: ThumbsUpActivate,
  },
  '👎': {
    center: ThumbsDownCenter, around: ThumbsDownAround, appear: ThumbsDownAppear,
    select: ThumbsDownSelect, effect: ThumbsDownEffect, activate: ThumbsDownActivate,
  },
  '🔥': {
    center: FireCenter, around: FireAround, appear: FireAppear,
    select: FireSelect, effect: FireEffect, activate: FireActivate,
  },
  '🥰': {
    center: HeartEyesCenter, around: HeartEyesAround, appear: HeartEyesAppear,
    select: HeartEyesSelect, effect: HeartEyesEffect, activate: HeartEyesActivate,
  },
  '👏': {
    center: ClapCenter, around: ClapAround, appear: ClapAppear,
    select: ClapSelect, effect: ClapEffect, activate: ClapActivate,
  },
  '😁': {
    center: GrinCenter, around: GrinAround, appear: GrinAppear,
    select: GrinSelect, effect: GrinEffect, activate: GrinActivate,
  },
  '🎉': {
    center: PartyCenter, around: PartyAround, appear: PartyAppear,
    select: PartySelect, effect: PartyEffect, activate: PartyActivate,
  },
  '🤔': {
    center: ThinkingCenter, around: ThinkingAround, appear: ThinkingAppear,
    select: ThinkingSelect, effect: ThinkingEffect, activate: ThinkingActivate,
  },
  '😢': {
    center: CryCenter, around: CryAround, appear: CryAppear,
    select: CrySelect, activate: CryActivate,
  },
  '😡': {
    center: AngryCenter, around: AngryAround, appear: AngryAppear,
    select: AngrySelect, effect: AngryEffect, activate: AngryActivate,
  },
  '👀': {
    center: EyesCenter, around: EyesAround, appear: EyesAppear,
    select: EyesSelect, effect: EyesEffect, activate: EyesActivate,
  },
  '🤯': {
    center: MindBlownCenter, around: MindBlownAround, appear: MindBlownAppear,
    select: MindBlownSelect, effect: MindBlownEffect, activate: MindBlownActivate,
  },
  '🤝': {
    center: HandshakeCenter, around: HandshakeAround, appear: HandshakeAppear,
    select: HandshakeSelect, effect: HandshakeEffect, activate: HandshakeActivate,
  },
  '🙏': {
    center: PrayCenter, around: PrayAround, appear: PrayAppear,
    select: PraySelect, effect: PrayEffect, activate: PrayActivate,
  },
  '👌': {
    center: OkCenter, around: OkAround, appear: OkAppear,
    select: OkSelect, effect: OkEffect, activate: OkActivate,
  },
  '💯': {
    center: HundredCenter, around: HundredAround, appear: HundredAppear,
    select: HundredSelect, activate: HundredActivate,
  },
  '🤣': {
    center: RoflCenter, around: RoflAround, appear: RoflAppear,
    select: RoflSelect, effect: RoflEffect, activate: RoflActivate,
  },
  '😎': {
    center: CoolCenter, around: CoolAround, appear: CoolAppear,
    select: CoolSelect, effect: CoolEffect, activate: CoolActivate,
  },
  '🤩': {
    center: StarStruckCenter, around: StarStruckAround, appear: StarStruckAppear,
    select: StarStruckSelect, effect: StarStruckEffect, activate: StarStruckActivate,
  },
  '💔': {
    center: BrokenHeartCenter, around: BrokenHeartAround, appear: BrokenHeartAppear,
    select: BrokenHeartSelect, effect: BrokenHeartEffect, activate: BrokenHeartActivate,
  },
